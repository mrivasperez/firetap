...
export function createAdapterConfig(config: Partial<CollaborationConfig>): AdapterOptions {
...
export function validateConfig(config: Partial<CollaborationConfig>): string[] {
  ...
  if (config.maxDirectPeers && (config.maxDirectPeers < 1 || config.maxDirectPeers > 20)) {
