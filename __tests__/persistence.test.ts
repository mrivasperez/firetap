...
describe('Persistence Module', () => {
  ...
  describe('persistDocument', () => {
    ...
    it('should use custom database paths when provided', async () => {
      ...
      await persistDocument(mockDatabase, ydoc, mockDocId, undefined, customPaths)
    ...
    it('should throw on persistence errors', async () => {
      ...
      await expect(persistDocument(mockDatabase, ydoc, mockDocId)).rejects.toThrow('Write failed')
    })
  })
  ...
  describe('persistDocumentIfChanged', () => {
    it('should persist when document has changes', async () => {
      ...
      const result = await persistDocumentIfChanged(mockDatabase, ydoc, mockDocId)
    ...
    it('should not persist when document unchanged', async () => {
      ...
      const result = await persistDocumentIfChanged(mockDatabase, ydoc, mockDocId, currentState)
  ...
  describe('startPeriodicPersistence', () => {
    it('should return cleanup function', () => {
      const cleanup = startPeriodicPersistence(mockDatabase, ydoc, mockDocId, 1000)
    ...
    it('should debounce rapid changes', async () => {
      const { set } = await import('firebase/database')
      const cleanup = startPeriodicPersistence(mockDatabase, ydoc, mockDocId, 10000)
    ...
    it('should use custom interval', () => {
      ...
      const cleanup = startPeriodicPersistence(mockDatabase, ydoc, mockDocId, customInterval)
  ...
  describe('createDocumentSnapshot', () => {
    ...
    it('should use custom database paths', async () => {
      ...
      await createDocumentSnapshot(mockDatabase, ydoc, mockDocId, undefined, customPaths)
  ...
  describe('loadDocumentSnapshot', () => {
    it('should return null when snapshot does not exist', async () => {
      ...
      const result = await loadDocumentSnapshot(mockDatabase, mockDocId, 'snapshot_123')
